...
public class systemDatePrint extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	      ...
	      out.println("<BODY style='background-color: #ffddcc;margin-top:100px'><div style = 'border:2px solid black;border-radius:15px;'><H1 align = \"center\">Display Current Date & Time:</H1>" );
